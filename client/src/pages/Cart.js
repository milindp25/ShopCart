...
const Cart = () => {
  ...
  useEffect(() => {
   const request = async () => {
     try{
      const req= await userRequest.post("/checkout/payments",{
            ...
            <Product>
              ...
              <PriceDetail>
                <ProductAmountContainer>
                  <Add />
                  <ProductAmount>{product.cartedQuantity}</ProductAmount>
                  <Remove />
                </ProductAmountContainer>
                <ProductPrice>${(product[0].price * product.cartedQuantity)}</ProductPrice>
              </PriceDetail>
            </Product>))}
            <Hr />
          </Info>
